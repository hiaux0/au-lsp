...
import { getAureliaComponentMap } from '../../../server/src/viewModel/getAureliaComponentMap';
...
export function getTestApplicationFiles() {
	...
	const filePaths = ts.sys.readDirectory(sourceDirectory, ['html'], ['node_modules', 'aurelia_project'], ['src']);
...
export function getAureliaProgramForTesting() {
	...
	getAureliaComponentMap(aureliaProgram, sourceDirectory);
